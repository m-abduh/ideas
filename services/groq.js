...
RULES KETAT:
- Judul HARUS format: "[Aplikasi/Platform/Tool] [kata kerja] [masalah] untuk [target]"
  Contoh benar: "Aplikasi rekomendasi menu dari sisa bahan kulkas untuk ibu rumah tangga"
  Contoh benar: "Platform jadwal & dokumen sidang otomatis untuk pengacara freelance"
  Contoh benar: "Tool tracking & notifikasi pajak untuk freelancer Indonesia"
  JANGAN pake nama brand/project seperti "Resepin", "SidangIN", "EcoLife", "SmartHealth", dll
...
[
  {
    "name": "Aplikasi/Platform/Tool [kata kerja] [masalah] untuk [target]",
